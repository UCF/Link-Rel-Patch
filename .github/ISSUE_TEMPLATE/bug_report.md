...
<!--
Thank you for reporting a possible bug in Link-Rel-Patch.
...
The version of this plugin can be found by clicking "Plugins" in the Admin navigation and finding "Link Rel Patch" in the list of plugins. The version number will be listed under the plugin description.
-->
